...
import org.vaadin.teemusav7.gridextensions.wrappinggrid.WrappingGrid;
...
public class WrappingGridConnector extends AbstractExtensionConnector {
	...
	private static native void removeWrappingRules(Element e) /*-{
		e.style.height = @org.vaadin.teemusav7.gridextensions.client.wrappinggrid.WrappingGridConnector::DEFAULT_HEIGHT;
		e.style.wordWrap = "";
		e.style.whiteSpace = "";
		e.style.overflow = "";
		e.style.texOverflow = "";
